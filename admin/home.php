...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in">
      ...
      The guest house has got various rooms that are categorised according to types. 
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseThree" class="panel-collapse collapse">
      <div class="panel-body">
       In this area, you can view all the reservation transaction of all guest. This area also allow the receptionist confirm the request of guest or to cancel their reservation. Click <a href="mod_reservation/index.php">HERE.</a>
       </div>
    </div>
  </div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapsesix" class="panel-collapse collapse">
      <div class="panel-body">
		    The system displays the list of all people that have been registered into the system.. To view all the registered other than the logged in user Click <a href="mod_users/index.php">HERE.</a>
      </div>
    </div>
  </div>
  <!-- <div class="panel panel-default">
