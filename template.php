...
<!--         <div class="search_button">
  ...
  <div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" style="background-color: black" data-speed="0.8"></div>
    <!-- <?php
      // echo 'data-image-src="<?php echo WEB_ROOT;?>images/home.jpg"';
    ?> -->
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>Jl. Telekomunikasi, Telkom University, Kota Bandung</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
...
<!-- Modal photo -->
  ...
  //Validates Personal Info
        ...
        {
        alert ('please agree the term and condition of this website');
        return false;
        }
